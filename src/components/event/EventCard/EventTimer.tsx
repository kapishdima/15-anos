    ...
    return (
      <div className="event-timer__countdown">
        <div className="event-timer__countdown-item">
          ...
          <span className="event-timer__countdown-item--title">{t('Days')}</span>
        </div>
        <div className="event-timer__countdown-item">
          <span className="event-timer__countdown-item--value">{hours}</span>
          <span className="event-timer__countdown-item--title">{t('Hours')}</span>
        </div>
        <div className="event-timer__countdown-item">
          <span className="event-timer__countdown-item--value">{minutes}</span>
          <span className="event-timer__countdown-item--title">{t('Minutes')}</span>
        </div>
        <div className="event-timer__countdown-item">
          <span className="event-timer__countdown-item--value">{seconds}</span>
          <span className="event-timer__countdown-item--title">{t('Seconds')}</span>
        </div>
      </div>
    );
  };
